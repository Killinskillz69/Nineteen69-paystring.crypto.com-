...
contract STARTokenERC20 {
    string public constant _myTokeName = 'Star Gold Token';//change here
    string public constant _mySymbol = 'STAR';//change here
...
contract MyAdvancedToken is owned, STARTokenERC20 {
    ...
    function MyAdvancedToken(
        ...
        string tokenName,
        string tokenSymbol
    ) STARTokenERC20(initialSupply, tokenName, tokenSymbol) public {}
