...
- [Democracy Earth](http://democracy.earth/): uses proof of identity via attention voting, quadratic voting and liquid democracy; governance platform for an organization of any size). It is "an open source and decentralized democratic governance protocol for any kind of organization."
