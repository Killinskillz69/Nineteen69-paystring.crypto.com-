...
To view the wiki locally, scroll to the bottom of the sidebar, and get the link to clone the wiki, (posting here for convenience: https://github.com/ethereum/wiki.wiki.git), then in a terminal, run `git clone https://github.com/ethereum/wiki.wiki.git`. FMI, see [here](https://help.github.com/articles/adding-and-editing-wiki-pages-locally/).
