...
**NOTE** This Documentation is for web3.js 0.20.x, for the web3.js 1.0 documentation please refer to [https://web3js.readthedocs.io/en/1.0](https://web3js.readthedocs.io/en/1.0)
...
- [Web3 JavaScript app API for 0.2x.x](#web3-javascript-app-api-for-02xx)
  ...
  - [Web3.js API Reference](#web3js-api-reference)
    - [Usage](#usage)
      - [web3](#web3)
        - [Example](#example)
          - [Example using HTTP Basic Authentication](#example-using-http-basic-authentication)
    ...
    - [web3.eth](#web3eth)
      ...
      - [web3.eth.syncing](#web3ethsyncing)
        - [Returns](#returns-23)
        - [Example](#example-25)
      - [web3.eth.isSyncing](#web3ethissyncing)
        - [Returns](#returns-24)
  ...
  - [Compiling features being deprecated https://github.com/ethereum/EIPs/issues/209](#compiling-features-being-deprecated-httpsgithubcomethereumeipsissues209)
    ...
    - [web3.shh](#web3shh)
      ...
      - [web3.shh.filter](#web3shhfilter)
        ...
        - [Callback return](#callback-return-2)
      - [web3.eth.sendIBANTransaction](#web3ethsendibantransaction)
