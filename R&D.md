...
### Sharding
Sharding introductory information includes:
- the [sharding phase 1 draft specification](https://ethresear.ch/t/sharding-phase-1-spec/1407);
- the [Sharding FAQ](https://github.com/ethereum/wiki/wiki/Sharding-FAQ);
- the [Ethereum Research Sharding Compendium](http://notes.ethereum.org/s/BJc_eGVFM); and
