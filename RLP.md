...
Note: it is planned for RLP to be **replaced** by a more preferable form of serialization, as outlined [here](https://ethresear.ch/t/blob-serialisation/1705), and implemented by [sharding clients](https://github.com/ethereum/wiki/wiki/Sharding-introduction-R&D-compendium#implementations).
