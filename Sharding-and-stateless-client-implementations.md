...
- [Drops of Diamond](https://github.com/Drops-of-Diamond/ethereumjs-vm): discontinued as the lead developer plans to develop an implementation on top of eWASM instead, with an implementation in Web Assembly.
