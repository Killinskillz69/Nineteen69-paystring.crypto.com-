...
contract CCXTokenERC20 {
    string public constant _myTokeName = 'Vergeclassic';//change here
    string public constant _mySymbol = 'XVGC';//change here
    uint public constant _myinitialSupply = 10000000000;//leave it
    uint8 public constant _myDecimal = 4;//leave it
