...
([smart
contracts](http://www.fon.hum.uva.nl/rob/Courses/InformationInSpeech/CDROM/Literature/LOTwinterschool2006/szabo.best.vwh.net/idea.html))
...
-   [Introduction to Bitcoin and Existing
    Concepts](#introduction-to-bitcoin-and-existing-concepts)
-   [History](#history)
-   [Bitcoin As A State Transition
    System](#bitcoin-as-a-state-transition-system)
-   [Mining](#mining)
-   [Merkle Trees](#merkle-trees)
-   [Alternative Blockchain
    Applications](#alternative-blockchain-applications)
-   [Scripting](#scripting)
-   [Ethereum](#ethereum)
...
![block\_picture.jpg](https://raw.githubusercontent.com/ethereumbuilders/GitBook/master/en/vitalik-diagrams/block.png)
...
![apply\_block\_diagram.png](https://raw.githubusercontent.com/ethereumbuilders/GitBook/master/en/vitalik-diagrams/apply_block_diagram.png)
